            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="rounded-4xl border border-neutral-800 bg-neutral-900/90 p-8 shadow-[0_40px_120px_rgba(0,0,0,0.35)] backdrop-blur-xl">
                    ...
                    <textarea
                        ...
                        className="mt-8 h-[60vh] w-full rounded-3xl border border-neutral-800 bg-neutral-950/80 px-5 py-5 text-sm leading-7 text-neutral-100 outline-none placeholder:text-neutral-500 focus:border-sky-400 focus:ring-2 focus:ring-sky-400/10 resize-none"
                    />
